...
file_1_name = r"new_op_falling_water"
file_2_name = r"existing_op_falling_water"
...
print("file_1_unique")
list_1_unique = [print(mod_name) for mod_name in list_1 if mod_name not in list_2]

print("\nfile_2_unique")
list_2_unique = [print(mod_name) for mod_name in list_2 if mod_name not in list_1]